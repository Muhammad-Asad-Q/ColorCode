# USAGE
# python classify.py --model output/fashion.model --categorybin output/category_lb.pickle --colorbin output/color_lb.pickle --image examples/color.jpg
...
file_names = [f for f in glob.glob("examples/*.jpg")]
...
# load the image
    ...
    filename = 'image_output/' +str(i)+'.jpg'
